...
public class Event {
   ...
   // @JsonProperty("document")
    ...
    public Event(String id, String direction, String networkProtocol, String receiverAddress, String senderAddress, String trn,
    ...
    public String toString() {
        return "Event [id="+id+",direction=" + direction + ", document=" + document + ", messageType=" + messageType
